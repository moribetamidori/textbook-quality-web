...
function SubjectNode({ data }: any) {
  const { subject, setSubject,node_idm1 } = useContext(StatusContext);
  return (
    <>
      <div className="flex flex-col border border-solid border-black h-full rounded-lg  bg-gradient-to-r from-[#5174ED]/40 to-[#1D1D1D] shadow-[0_7px_9px_0_rgba(0,0,0,0.02)]">
      ...
      <Handle
        style={{ width: "10px", height: "10px", backgroundColor: "#5174ED" }}
        type="target"
